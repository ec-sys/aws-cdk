...
import com.myorg.todo.person.PersonRepository;
import com.myorg.todo.todo.Todo;
import com.myorg.todo.todo.TodoRepository;
...
public class TodoCollaborationService {
    ...
    public boolean confirmCollaboration(String authenticatedUserEmail, Long todoId, Long collaboratorId, String token) {
        ...
        simpMessagingTemplate.convertAndSendToUser(ownerEmail, "/queue/todo-updates", subject + " " + message);
